const projects = [
  ...
  },
  {
    ...
    year: '2022',
    description:
      'Expansion on Spotlist that offers insights into user created playlists, such as genre, history, and audio features. Built with Next.js. [Under Development].',
    link: 'https://spot.rence.la/',
  },
  {
    title: 'Remember',
    year: '2022',
    description:
      "Things that we should remember even as we get older. Hopefully it'll provide courage for you to fight another day. [Under Development].",
    link: 'https://remember.rence.la/',
  },
  {
    title: "Media's Role in American Public Opinion of China",
    year: '2022',
    description:
    ...
    link: 'https://media.rence.la/',
  },
  {
    title: 'Electoral System in the P.R.C.',
    year: '2022',
    description:
    ...
    link: 'https://prc.rence.la/',
  },
  {
    title: 'Chinese Idioms',
    year: '2022',
    description:
      'Presenting some of my favorite Chinese idioms with infinite scroll, SVG stretch animation, and a dictionary. [Under Development].',
